...
import com.movieapp.cotrollers.PostController;
...
public class PostControllerIntegrationTest {
	...
	public void setUp() {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(postController).setViewResolvers(viewResolver)
		.build();
	...
	public void saveMovie() throws Exception {
		...
		doNothing().when(userService).saveUserMovie(any());
